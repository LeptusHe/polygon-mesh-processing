...
target("08-mesh-segmentation")
    set_languages("c++17")
    set_kind("binary")
    add_files("apps/mesh-segmentation/*.cc")
    add_packages(packages)
    add_includedirs(include_dirs)
    add_deps("meshlib")

target("09-quadric-mesh-simplification")
    set_languages("c++17")
    set_kind("binary")
    add_files("apps/qslim/*.cc")
    add_packages(packages)
    add_includedirs(include_dirs)
    add_deps("meshlib")

target("10-parametrization-lscm")
    set_languages("c++17")
    set_kind("binary")
    add_files("apps/lscm/*.cc")
    add_packages(packages)
    add_includedirs(include_dirs)
    add_deps("meshlib")